...
if (TotalSlt!=0){Print("������ ���������� ������ BuyStop �� ������ ����� �������� ������� Sell"); GoGoBuy=TotalSlt*Percent/100/Lot1;if ((AccountEquity()/MM)>(TotalSlt*Percent/100/Lot1)){GoGoBuy=(AccountEquity()/MM);}   }
...
if (TotalBLt!=0){Print("������ ���������� ������ Sell �� ������ ����� �������� ������� Buy"); GoGoSell=TotalBLt*Percent/100/Lot1;if ((AccountEquity()/MM)>(TotalBLt*Percent/100/Lot1)){GoGoSell=(AccountEquity()/MM);}}
