...
ObjectSetText("label_object1","���������� ������� Buy="+CountBuy+"; ��������� ���="+DoubleToStr(TotalBLt,2));
...
ObjectSetText("label_object2","���������� ������� Sell="+CountSell+"; ��������� ���="+DoubleToStr(TotalSlt,2));
...
if((ReCloseLokB==true)&& (ReBuyLots!=BuyLots)){Print("��������� ������� buy");CalculateTotalBuyTP();}
if((ReCloseLokS==true)&& (ReSellLots!=SellLots)){Print("��������� ������� sell");CalculateTotalSellTP();}
